...
from models.feature_model import build_model
...
def my_train(cfg):
    ...
    if cfg.NUM_GPUS>1:
        ...
        policy = model.get_optim_policies()
    ...
    train_loader, val_loader, test_loader = get_loaders(Uniformer_Feature_DataSet)
        ...
        if is_eval_epoch and torch.cuda.current_device()==0:
            ...
            if prec_1 > best_prec:
                if cfg.NUM_GPUS>1:
                    ...
                    torch.save(model.state_dict(),os.path.join(weight_root,f"best_prec.pth"))
            ...
            if roc_auc_1 > best_roc_auc:
                if cfg.NUM_GPUS>1:
                    ...
                    torch.save(model.state_dict(),os.path.join(weight_root,f"best_auc.pth"))
            ...
            if is_checkp_epoch:
                if cfg.NUM_GPUS>1:
                    ...
                    torch.save(model.state_dict(),os.path.join(weight_root,f"epoch{epoch}.pth"))
