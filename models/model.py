...
from Uniformerv2 import uniformerv2_l14,uniformerv2_b16
...
class Uniformer_ART(nn.Module):
    def __init__(self, num_class, num_segments, modality,
        ...
        self.Vedio_block = uniformerv2_l14(
           t_size=num_segments,
    ...
    def get_optim_policies(self):
        ...
        return [
            # {"params": finetune_param_lst, "lr_mult": 1, "name": "finetune_param"},
            # {"params": rest_vedio_param_lst, "lr_mult": 0, "name": "rest_vedio_param"},
